...
function Navbar() {
  return (
    ...
    <a className="navbar-brand" href="#" style={{marginLeft: '5px'}}>
      <img src="../public/kanban Icon.png" alt="" width="30" height="24" className="d-inline-block align-text-top"/>
   <a  style={{marginLeft: '5px', fontSize:'20px', fontWeight:'bolder'}}> Kanban Board</a> 
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <a className="navbar-brand" href="#" style={{marginLeft: '5px'}}>
      <img src="../public/profileKanban.jfif" alt="" width="30" height="24" className="d-inline-block align-text-top"  style={{height: '25px', borderRadius:'50%'}}></img>
